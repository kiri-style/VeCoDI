## NS Aggregate Cycle Statistics (incl. IRQ-masked)

| Stage         | Count | Sum (cycles) | Avg (cycles) | Min (cycles) | Max (cycles) | Avg (ms) |
|-------------- |------:|-------------:|-------------:|-------------:|-------------:|---------:|
| enclave_create|     1 |   4,719,136  |   4,719,136  |   4,719,136  |   4,719,136  |   42.90  |
| aes_decrypt   |     1 |   1,043,519  |   1,043,519  |   1,043,519  |   1,043,519  |    9.49  |
| early_layers  |    10 |  25,983,344  |   2,598,334  |     617,969  |   2,818,896  |   23.62  |
| late_layers   |    10 |  14,937,660  |   1,493,766  |   1,271,035  |   3,472,703  |   13.58  |
| total_inference|   10 |  41,158,115  |   4,115,811  |   4,112,712  |   4,117,032  |   37.42  |
| run_enclave   |    11 |  46,396,654  |   4,217,877  |   4,161,207  |   4,753,526  |   38.34  |
| irq_atomic    |    11 |  87,735,074  |   7,975,915  |   7,661,716  |   9,950,071  |   72.51  |

**IRQ-masked atomic window**: count=11, avg=7,975,915 cycles (72.51 ms), sum=87,735,074 cycles (797.59 ms), min=7,661,716, max=9,950,071
...
**Test:** Single inference with ECDH handshake and M_update (quota=21)
